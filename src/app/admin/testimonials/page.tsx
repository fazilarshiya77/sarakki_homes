    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {testimonials.map((t) => (
                <div
                  key={t.id}
                  className="p-5 rounded-sm border border-border/20 bg-card/25 backdrop-blur-md flex flex-col justify-between"
                >
                  ...
                  <div className="mt-4 pt-3 border-t border-border/10 flex flex-col">
        ...
        <div className="rounded-sm border border-border/20 bg-card/25 p-6 backdrop-blur-md space-y-4">
          <div>
            <span className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Add Testimonial</span>
            <p className="text-[10px] text-muted-foreground mt-0.5">Register a new client review.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">Client Designation / Role</label>
              <input
                type="text"
                value={role}
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">Rating</label>
              <select
                value={rating}
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">Review Quote</label>
              <textarea
                rows={4}
                required
                value={quote}
