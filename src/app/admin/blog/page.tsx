    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div key={b.id} className="p-4 text-xs space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] uppercase font-semibold text-crm-text-secondary">
        ...
        <div className="rounded-sm border border-crm-border/20 bg-crm-card/25 p-6 backdrop-blur-md space-y-4">
          <div>
            <span className="text-xs font-semibold uppercase tracking-wider text-crm-text-secondary">New Article</span>
            <p className="text-[10px] text-crm-text-secondary mt-0.5">Write a new guide page.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-[10px] font-semibold uppercase tracking-wider text-crm-text-secondary">Article Title</label>
              <input
                type="text"
                required
                value={title}
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-semibold uppercase tracking-wider text-crm-text-secondary">Featured Image URL</label>
              <input
                type="text"
                value={featuredImage}
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-semibold uppercase tracking-wider text-crm-text-secondary">Content Markdown</label>
              <textarea
                rows={6}
                required
                value={content}
            ...
            <div className="space-y-1.5 flex items-center justify-between border border-crm-border/20 bg-crm-bg/40 rounded-sm p-4 mt-6">
              <div className="flex flex-col">
                <span className="text-xs font-semibold text-crm-text">Publish Immediately</span>
                <span className="text-[10px] text-crm-text-secondary mt-0.5">Visible to search crawlers</span>
              </div>
              <input
                type="checkbox"
                checked={published}
