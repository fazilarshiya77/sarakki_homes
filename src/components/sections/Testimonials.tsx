    ...
    <Section id="testimonials" className="bg-accent-emerald-dark relative overflow-hidden !py-24 md:!py-36">
      ...
      <Container className="relative z-10 flex flex-col items-center">
          ...
          <div className="relative w-full aspect-[16/10] select-none book-perspective">
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  <h3 className="font-display text-4xl text-[#F5F1E8] tracking-wider font-bold">
                    SARAKKI HOMES
                  </h3>
                ...
                <span className="text-[10px] uppercase tracking-[0.15em] text-[#F5F1E8]/40 mb-8 hover:text-[#C6A15B] transition-colors">
              ...
              <div
                ...
                className="page-face-left absolute inset-0 bg-[#F5F1E8] p-12 pr-16 flex flex-col justify-between backface-hidden rotate-y-180 rounded-l-md shadow-[inset_10px_0_20px_rgba(0,0,0,0.03)] border-r border-black/5"
              >
                  ...
                  <div>
                    ...
                    <div className="mt-8 space-y-4">
                      {CLIENT_TESTIMONIALS.map((t, idx) => (
                        ...
                        >
                          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[#C6A15B]/40 bg-[#F5F1E8] text-xs font-semibold font-display text-[#C6A15B] shadow-sm">
                            {t.initials}
                          </div>
            ...
            >
              ...
              <div
                ...
                className="page-face-right absolute inset-0 bg-[#F5F1E8] p-12 pl-16 flex flex-col justify-between backface-hidden rounded-r-md shadow-[inset_-10px_0_20px_rgba(0,0,0,0.03)] border-l border-black/5"
              >
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.8)_0%,rgba(248,246,240,0.2)_100%)] pointer-events-none" />
            ...
            >
                  ...
                  <div className="my-auto max-w-sm space-y-6">
                    ...
                    <div className="pt-4">
                      <button
                        ...
                        className="inline-flex items-center justify-center rounded-sm bg-[#C6A15B] px-8 py-3.5 text-xs font-semibold uppercase tracking-[0.1em] text-[#F5F1E8] transition-all hover:bg-[#B3955A] hover:shadow-md"
                      >
              ...
              <div
                ...
                className="page-face-left absolute inset-0 bg-[#F5F1E8] p-12 pr-16 flex flex-col justify-between backface-hidden rotate-y-180 rounded-l-md shadow-[inset_10px_0_20px_rgba(0,0,0,0.03)] border-r border-black/5 text-xs"
              >
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.8)_0%,rgba(248,246,240,0.2)_100%)] pointer-events-none" />
                ...
                <div className="flex flex-col h-full justify-between relative z-10 text-[#171715]">
                  ...
                  <div className="pt-2">
                    <a
                      ...
                      className="inline-flex items-center gap-2 border border-[#C6A15B]/50 rounded-sm px-4 py-2 hover:bg-[#F6F3EE] transition-colors font-semibold text-[10px] uppercase tracking-wider text-[#C6A15B]"
                    >
            ...
            >
                  ...
                  <div className="my-auto max-w-xs space-y-6">
                    ...
                    <div className="pt-2">
                      <a
                        ...
                        rel="noopener noreferrer"
                        onClick={(e) => e.stopPropagation()}
                        className="inline-flex items-center justify-center rounded-sm bg-[#C6A15B] px-6 py-2.5 text-[10px] font-semibold uppercase tracking-[0.1em] text-[#F5F1E8] transition-all hover:bg-[#B3955A]"
                      >
                        Book a Consultation
                      </a>
                    </div>
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="font-display text-base tracking-[0.1em] text-[#F5F1E8]/80 font-bold uppercase">
                    Sarakki Homes
                  </p>
            ...
            {currentLeaf > 0 && (
              <button
                onClick={flipBackward}
                className="absolute left-[-60px] top-[calc(50%-22px)] h-11 w-11 rounded-full border border-border bg-[#F5F1E8] shadow-soft flex items-center justify-center hover:bg-[#F6F3EE] hover:-translate-x-0.5 transition-all text-[#171715] z-40"
            ...
            {currentLeaf < 5 && (
              <button
                onClick={flipForward}
                className="absolute right-[-60px] top-[calc(50%-22px)] h-11 w-11 rounded-full border border-border bg-[#F5F1E8] shadow-soft flex items-center justify-center hover:bg-[#F6F3EE] hover:translate-x-0.5 transition-all text-[#171715] z-40"
        ...
        <div className="flex md:hidden flex-col items-center w-full max-w-sm">
          <div className="relative w-full aspect-[4/5] rounded-md border border-black/10 bg-[#F5F1E8] shadow-[0_20px_50px_rgba(0,0,0,0.12)] overflow-hidden p-8 flex flex-col justify-between select-none">
            ...
            {mobilePage === 0 && (
              <div className="absolute inset-0 bg-[#052C27] p-8 flex flex-col justify-between items-center text-center">
                ...
                <div className="flex flex-col items-center">
                  <h3 className="font-display text-3xl text-[#F5F1E8] tracking-wider font-bold">
                    SARAKKI HOMES
                  </h3>
                ...
                <span className="text-[9px] uppercase tracking-[0.12em] text-[#F5F1E8]/40 mb-4" onClick={nextMobile}>
                ...
                <div>
                  ...
                  <div className="mt-6 space-y-2.5">
                    {CLIENT_TESTIMONIALS.map((t, idx) => (
                      ...
                      >
                        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#C6A15B]/40 bg-[#F5F1E8] text-[10px] font-semibold font-display text-[#C6A15B]">
                          {t.initials}
                        </div>
                        <div className="flex flex-col">
              ...
              <div className="h-full flex flex-col justify-between items-center text-center">
                <div className="my-auto space-y-4">
                  ...
                  <div className="pt-2">
                    <button
                      onClick={nextMobile}
                      className="inline-flex items-center justify-center rounded-sm bg-[#C6A15B] px-6 py-3 text-[10px] font-semibold uppercase tracking-[0.1em] text-[#F5F1E8]"
                    >
                      Contact & Locations
                    </button>
                  </div>
            ...
            {mobilePage === 8 && (
              <div className="absolute inset-0 bg-[#052C27] p-8 flex flex-col justify-between items-center text-center">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="font-display text-sm tracking-[0.1em] text-[#F5F1E8]/80 font-bold uppercase">
                    Sarakki Homes
                  </p>
                  <p className="text-[9px] text-muted-foreground mt-1">© 2026 All Rights Reserved.</p>
                </div>
                <span className="text-[9px] uppercase tracking-[0.12em] text-[#F5F1E8]/40 mb-4" onClick={() => setMobilePage(0)}>
                  ← Restart Portfolio
                </span>
              </div>
            )}
    ...
    <div className="flex flex-col h-full justify-between relative">
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="flex items-center gap-4">
          <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-[#C6A15B]/40 bg-[#F5F1E8] text-lg font-semibold font-display text-[#C6A15B] shadow-sm select-none">
  ...
  return (
    <div className="flex flex-col h-full justify-between relative">
      ...
      <div className="relative z-10 space-y-4">
        {/* Customer Badge */}
        <div className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-full border border-[#C6A15B]/40 bg-[#F5F1E8] text-sm font-semibold font-display text-[#C6A15B] shadow-sm">
            {testimonial.initials}
          </div>
          <div className="flex flex-col">
