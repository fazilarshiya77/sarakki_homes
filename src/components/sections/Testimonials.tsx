...
export function Testimonials({ testimonials }: { testimonials: TestimonialData[] }) {
  ...
  return (
    <Section id="testimonials" className="bg-[#F6F3EE] relative overflow-hidden !py-24 md:!py-36">
      {/* Soft radial vignette background */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.45)_0%,rgba(238,232,220,0.8)_100%)] pointer-events-none" />
      
      <Container className="relative z-10 flex flex-col items-center">
        <div className="text-center mb-16 max-w-2xl">
          <Eyebrow className="justify-center">Client Trust</Eyebrow>
          <h2 className="mt-4 font-display text-4xl leading-[1.1] tracking-[-0.01em] md:text-5xl text-[#1C1C1C]">
          ...
          <div className="relative w-full aspect-[16/10] select-none book-perspective">
            ...
            >
              ...
              <div
                ...
                className="page-face-right absolute inset-0 bg-[#332C26] border border-[#C4A66B]/30 shadow-[inset_-2px_0_10px_rgba(0,0,0,0.4)] p-12 flex flex-col justify-between items-center text-center backface-hidden rounded-r-md"
              >
                ...
                <div className="absolute inset-4 border border-[#C4A66B]/20 pointer-events-none rounded-sm" />

                <div className="absolute top-6 left-6 w-4 h-4 border-t border-l border-[#C4A66B]/30" />
                <div className="absolute top-6 right-6 w-4 h-4 border-t border-r border-[#C4A66B]/30" />
                <div className="absolute bottom-6 left-6 w-4 h-4 border-b border-l border-[#C4A66B]/30" />
                <div className="absolute bottom-6 right-6 w-4 h-4 border-b border-r border-[#C4A66B]/30" />

                <span className="text-xs uppercase tracking-[0.2em] text-[#C4A66B]/60 font-semibold mt-8">Exclusive Portfolio</span>

                <div className="flex flex-col items-center">
                  <h3 className="font-display text-4xl text-[#FCFBF9] tracking-wider font-bold">
                    SARAKKI HOMES
                  </h3>
                  <div className="w-12 h-[1px] bg-[#C4A66B]/40 my-6" />
                  <p className="font-display text-lg italic text-[#C4A66B] tracking-wide">
                    Trusted Property Stories
                  </p>
                </div>

                <span className="text-[10px] uppercase tracking-[0.15em] text-[#FCFBF9]/40 mb-8 hover:text-[#C4A66B] transition-colors">
              ...
              <div
                ...
                className="page-face-left absolute inset-0 bg-[#FCFBF9] p-12 pr-16 flex flex-col justify-between backface-hidden rotate-y-180 rounded-l-md shadow-[inset_10px_0_20px_rgba(0,0,0,0.03)] border-r border-black/5"
              >
                ...
                <div className="flex flex-col h-full justify-between relative z-10">
                  <div>
                    <h4 className="font-display text-2xl tracking-wide text-[#1C1C1C]">Client Stories</h4>
                    ...
                    <div className="mt-8 space-y-4">
                      {CLIENT_TESTIMONIALS.map((t, idx) => (
                        <div
                          ...
                          className="flex items-center gap-4 p-3 rounded-sm hover:bg-[#F6F3EE] transition-colors cursor-pointer group border border-transparent hover:border-border/40"
                        >
                          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[#C4A66B]/40 bg-[#FCFBF9] text-xs font-semibold font-display text-[#C4A66B] shadow-sm">
                            {t.initials}
                          </div>
                          <div className="flex flex-col">
                            <span className="font-semibold text-sm text-[#1C1C1C] group-hover:text-accent-gold-dark transition-colors">
                              {t.name}
                            </span>
            ...
            >
              ...
              <div
                ...
                className="page-face-right absolute inset-0 bg-[#FCFBF9] p-12 pl-16 flex flex-col justify-between backface-hidden rounded-r-md shadow-[inset_-10px_0_20px_rgba(0,0,0,0.03)] border-l border-black/5"
              >
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.8)_0%,rgba(248,246,240,0.2)_100%)] pointer-events-none" />
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col h-full justify-between items-center text-center relative z-10">
                  <div className="my-auto max-w-sm space-y-6">
                    <span className="text-xs uppercase tracking-[0.15em] text-[#C4A66B] font-semibold">Your Next Chapter</span>
                    <h4 className="font-display text-3xl leading-tight text-[#1C1C1C]">
                    ...
                    <div className="pt-4">
                      <button
                        ...
                        className="inline-flex items-center justify-center rounded-sm bg-[#C4A66B] px-8 py-3.5 text-xs font-semibold uppercase tracking-[0.1em] text-[#FCFBF9] transition-all hover:bg-[#B3955A] hover:shadow-md"
                      >
              ...
              <div
                ...
                className="page-face-left absolute inset-0 bg-[#FCFBF9] p-12 pr-16 flex flex-col justify-between backface-hidden rotate-y-180 rounded-l-md shadow-[inset_10px_0_20px_rgba(0,0,0,0.03)] border-r border-black/5 text-xs"
              >
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.8)_0%,rgba(248,246,240,0.2)_100%)] pointer-events-none" />
                
                <div className="flex flex-col h-full justify-between relative z-10 text-[#1C1C1C]">
                  <div className="space-y-5">
                    <h4 className="font-display text-2xl tracking-wide">Office Location</h4>
                    <div className="w-12 h-[1.5px] bg-[#C4A66B]" />
                    ...
                    <div className="space-y-4 text-xs leading-relaxed">
                      ...
                      <div className="grid grid-cols-1 gap-3.5 pt-2 border-t border-border/60">
                        ...
                        <div className="flex items-center gap-3">
                          <Clock size={14} className="text-[#C4A66B] shrink-0" />
                          <p>
                  ...
                  <div className="pt-2">
                    <a
                      ...
                      className="inline-flex items-center gap-2 border border-[#C4A66B]/50 rounded-sm px-4 py-2 hover:bg-[#F6F3EE] transition-colors font-semibold text-[10px] uppercase tracking-wider text-[#C4A66B]"
                    >
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col h-full justify-between items-center text-center relative z-10">
                  <div className="my-auto max-w-xs space-y-6">
                    <span className="h-10 w-10 rounded-full border border-[#C4A66B]/30 flex items-center justify-center text-[#C4A66B] font-display text-sm mx-auto">S</span>
                    <h4 className="font-display text-xl tracking-widest text-[#1C1C1C] uppercase font-bold">
                      Sarakki Homes
                    </h4>
                    ...
                    <div className="pt-2">
                      <a
                        ...
                        rel="noopener noreferrer"
                        onClick={(e) => e.stopPropagation()}
                        className="inline-flex items-center justify-center rounded-sm bg-[#C4A66B] px-6 py-2.5 text-[10px] font-semibold uppercase tracking-[0.1em] text-[#FCFBF9] transition-all hover:bg-[#B3955A]"
                      >
                        Book a Consultation
                      </a>
                    </div>
              ...
              <div
                ...
                className="page-face-left absolute inset-0 bg-[#332C26] border border-[#C4A66B]/30 shadow-[inset_2px_0_10px_rgba(0,0,0,0.4)] p-12 flex flex-col justify-between items-center text-center backface-hidden rotate-y-180 rounded-l-md"
              >
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.03)_0%,rgba(0,0,0,0.15)_100%)] mix-blend-overlay pointer-events-none" />
                <div className="absolute inset-4 border border-[#C4A66B]/20 pointer-events-none rounded-sm" />
                ...
                <span className="text-[#C4A66B]/40 text-[10px] uppercase tracking-[0.2em] font-semibold mt-8">End of Portfolio</span>

                <div className="flex flex-col items-center">
                  <span className="h-6 w-6 rounded-full border border-[#C4A66B]/40 flex items-center justify-center text-[#C4A66B] font-display text-xs mb-4">S</span>
                  <p className="font-display text-base tracking-[0.1em] text-[#FCFBF9]/80 font-bold uppercase">
                    Sarakki Homes
                  </p>
            ...
            {currentLeaf > 0 && (
              <button
                onClick={flipBackward}
                className="absolute left-[-60px] top-[calc(50%-22px)] h-11 w-11 rounded-full border border-border bg-[#FCFBF9] shadow-soft flex items-center justify-center hover:bg-[#F6F3EE] hover:-translate-x-0.5 transition-all text-[#1C1C1C] z-40"
            ...
            {currentLeaf < 5 && (
              <button
                onClick={flipForward}
                className="absolute right-[-60px] top-[calc(50%-22px)] h-11 w-11 rounded-full border border-border bg-[#FCFBF9] shadow-soft flex items-center justify-center hover:bg-[#F6F3EE] hover:translate-x-0.5 transition-all text-[#1C1C1C] z-40"
            ...
            {[0, 1, 2, 3, 4, 5].map((idx) => (
              <button
                ...
                className={`h-1.5 transition-all duration-300 rounded-full ${
                  currentLeaf === idx ? "w-6 bg-[#C4A66B]" : "w-1.5 bg-[#C4A66B]/20"
                }`}
        ...
        <div className="flex md:hidden flex-col items-center w-full max-w-sm">
          <div className="relative w-full aspect-[4/5] rounded-md border border-black/10 bg-[#FCFBF9] shadow-[0_20px_50px_rgba(0,0,0,0.12)] overflow-hidden p-8 flex flex-col justify-between select-none">
            
            {mobilePage === 0 && (
              <div className="absolute inset-0 bg-[#332C26] p-8 flex flex-col justify-between items-center text-center">
                <div className="absolute inset-4 border border-[#C4A66B]/20 pointer-events-none rounded-sm" />
                <span className="text-[10px] uppercase tracking-[0.15em] text-[#C4A66B]/60 font-semibold mt-4">Exclusive Portfolio</span>
                <div className="flex flex-col items-center">
                  <h3 className="font-display text-3xl text-[#FCFBF9] tracking-wider font-bold">
                    SARAKKI HOMES
                  </h3>
                  <div className="w-10 h-[1px] bg-[#C4A66B]/40 my-4" />
                  <p className="font-display text-sm italic text-[#C4A66B] tracking-wide">
                    Trusted Property Stories
                  </p>
                </div>
                <span className="text-[9px] uppercase tracking-[0.12em] text-[#FCFBF9]/40 mb-4" onClick={nextMobile}>
            ...
            {mobilePage === 1 && (
              <div className="h-full flex flex-col justify-between">
                <div>
                  <h4 className="font-display text-xl tracking-wide text-[#1C1C1C]">Client Stories</h4>
                  ...
                  <div className="mt-6 space-y-2.5">
                    {CLIENT_TESTIMONIALS.map((t, idx) => (
                      <div
                        ...
                        className="flex items-center gap-3 p-2.5 rounded-sm bg-[#F6F3EE]/40 border border-border/20 cursor-pointer"
                      >
                        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#C4A66B]/40 bg-[#FCFBF9] text-[10px] font-semibold font-display text-[#C4A66B]">
                          {t.initials}
                        </div>
                        <div className="flex flex-col">
                          <span className="font-semibold text-xs text-[#1C1C1C]">
                            {t.name}
                          </span>
            ...
            {mobilePage === 6 && (
              <div className="h-full flex flex-col justify-between items-center text-center">
                <div className="my-auto space-y-4">
                  <span className="text-[10px] uppercase tracking-[0.12em] text-[#C4A66B] font-semibold">Your Next Chapter</span>
                  <h4 className="font-display text-2xl leading-snug text-[#1C1C1C]">
                    Begin Your Investment Journey
                  </h4>
                  ...
                  <div className="pt-2">
                    <button
                      onClick={nextMobile}
                      className="inline-flex items-center justify-center rounded-sm bg-[#C4A66B] px-6 py-3 text-[10px] font-semibold uppercase tracking-[0.1em] text-[#FCFBF9]"
                    >
                      Contact & Locations
                    </button>
                  </div>
            ...
            {mobilePage === 7 && (
              <div className="h-full flex flex-col justify-between relative z-10 text-[#1C1C1C] text-xs">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3.5 leading-relaxed text-[11px]">
                    <div className="flex gap-2">
                      <MapPin size={14} className="text-[#C4A66B] shrink-0 mt-0.5" />
                ...
                <div className="pt-2 flex justify-between items-center border-t border-border/40">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 border border-[#C4A66B]/50 rounded-sm px-3 py-1.5 text-[9px] uppercase tracking-wider text-[#C4A66B]"
                  >
            ...
            {mobilePage === 8 && (
              <div className="absolute inset-0 bg-[#332C26] p-8 flex flex-col justify-between items-center text-center">
                <div className="absolute inset-4 border border-[#C4A66B]/20 pointer-events-none rounded-sm" />
                <span className="text-[#C4A66B]/40 text-[9px] uppercase tracking-[0.15em] font-semibold mt-4">End of Portfolio</span>
                <div className="flex flex-col items-center">
                  <span className="h-5 w-5 rounded-full border border-[#C4A66B]/40 flex items-center justify-center text-[#C4A66B] font-display text-[10px] mb-3">S</span>
                  <p className="font-display text-sm tracking-[0.1em] text-[#FCFBF9]/80 font-bold uppercase">
                    Sarakki Homes
                  </p>
                  <p className="text-[9px] text-muted-foreground mt-1">© 2026 All Rights Reserved.</p>
                </div>
                <span className="text-[9px] uppercase tracking-[0.12em] text-[#FCFBF9]/40 mb-4" onClick={() => setMobilePage(0)}>
                  ← Restart Portfolio
                </span>
              </div>
            )}
          ...
          <div className="flex items-center justify-between w-full mt-6 px-4">
            <button
              ...
              className="flex items-center gap-1.5 text-xs font-semibold text-[#1C1C1C] disabled:opacity-30 disabled:pointer-events-none"
            >
...
function TestimonialPage({ testimonial, pageNum }: { testimonial: TestimonialData; pageNum: number }) {
  return (
    <div className="flex flex-col h-full justify-between relative">
      ...
      <span className="absolute top-2 left-[-16px] font-display text-[9rem] text-[#C4A66B]/10 leading-none select-none">
        &ldquo;
      </span>
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="flex items-center gap-4">
          <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-[#C4A66B]/40 bg-[#FCFBF9] text-lg font-semibold font-display text-[#C4A66B] shadow-sm select-none">
            {testimonial.initials}
          </div>
          <div className="flex flex-col">
            <h5 className="font-display text-xl font-bold tracking-wide text-[#1C1C1C]">{testimonial.name}</h5>
        ...
        <div className="flex items-center gap-1">
          {[...Array(5)].map((_, i) => (
            <Star key={i} size={11} fill="#C4A66B" className="text-[#C4A66B]" />
          ))}
        </div>

        {/* Large Quote */}
        <p className="font-display text-2xl italic leading-relaxed text-[#1C1C1C]/90 font-light pr-2">
          &ldquo;{testimonial.quote}&rdquo;
        </p>

        {/* Signature-style calligraphy loops divider line */}
        <div className="pt-2 flex items-center gap-3">
          <div className="w-16 h-[1px] bg-[#C4A66B]/30" />
          <svg className="w-12 h-6 text-[#C4A66B]/40" viewBox="0 0 100 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 20 C 30 5, 40 35, 50 20 C 60 5, 70 35, 90 20" stroke="currentColor" strokeWidth="1.5" fill="none" />
          </svg>
          <div className="flex-1 h-[1px] bg-[#C4A66B]/30" />
        </div>

        {/* Property Type / Category badge */}
        <div>
          <span className="text-[10px] font-semibold uppercase tracking-wider text-[#C4A66B] bg-[#C4A66B]/8 px-3 py-1 rounded-sm">
...
function MobileTestimonialPage({ testimonial, pageNum }: { testimonial: TestimonialData; pageNum: number }) {
  return (
    <div className="flex flex-col h-full justify-between relative">
      <span className="absolute top-0 left-[-8px] font-display text-[7rem] text-[#C4A66B]/8 leading-none select-none">
        &ldquo;
      </span>
      ...
      <div className="relative z-10 space-y-4">
        {/* Customer Badge */}
        <div className="flex items-center gap-3">
          <div className="flex h-12 w-12 items-center justify-center rounded-full border border-[#C4A66B]/40 bg-[#FCFBF9] text-sm font-semibold font-display text-[#C4A66B] shadow-sm">
            {testimonial.initials}
          </div>
          <div className="flex flex-col">
            <h5 className="font-display text-base font-bold text-[#1C1C1C]">{testimonial.name}</h5>
        ...
        <div className="flex items-center gap-0.5">
          {[...Array(5)].map((_, i) => (
            <Star key={i} size={10} fill="#C4A66B" className="text-[#C4A66B]" />
          ))}
        </div>

        {/* Quote */}
        <p className="font-display text-lg italic leading-relaxed text-[#1C1C1C]/90 font-light">
          &ldquo;{testimonial.quote}&rdquo;
        </p>

        {/* Divider SVG */}
        <div className="flex items-center gap-2">
          <div className="w-8 h-[1px] bg-[#C4A66B]/20" />
          <svg className="w-8 h-4 text-[#C4A66B]/30" viewBox="0 0 100 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M10 20 C 30 5, 40 35, 50 20 C 60 5, 70 35, 90 20" stroke="currentColor" strokeWidth="1.5" fill="none" />
          </svg>
          <div className="flex-1 h-[1px] bg-[#C4A66B]/20" />
        </div>

        {/* Category */}
        <div>
          <span className="text-[8px] font-semibold uppercase tracking-wider text-[#C4A66B] bg-[#C4A66B]/8 px-2 py-0.5 rounded-sm">
            {testimonial.category}
          </span>
        </div>
      </div>
